...
<div class="row">
<div class="col-lg-6">
<span class="logo">Aazmoon</span></div>
...
{
echo '<tr style="color:#2db44a"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This exam has been already solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="TechGirls" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">TechGirls</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+93789842636</h4>
		<h4 style="font-family:'typo' ">techgirls@gmail.com</h4>
		<h4 style="font-family:'typo' ">Balkh University</h4></div></div>
		</p>
      </div>
